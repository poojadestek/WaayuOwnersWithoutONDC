...
public class SessionManager {
    ...
    public static String mobl="";
    public static String plod="";
    public static String dateod="";
    ...
    public void setPendingData(String key, String val) {
        mEditor.putString(key, val);
        mEditor.commit();
    }

    public String getPendingData(String key) {

        return mPrefs.getString(key,"Pending");
    }
}
