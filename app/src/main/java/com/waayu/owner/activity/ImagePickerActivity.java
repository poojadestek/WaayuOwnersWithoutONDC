...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    public interface PickerOptionListener {
        ...
        void onChooseGalleryRemoveSelected();
    }
    ...
    public static void showImagePickerOptions(Context context, PickerOptionListener listener) {
        ...
        // add a list
        String[] animals = {context.getString(R.string.lbl_take_camera_picture), context.getString(R.string.lbl_choose_from_gallery), context.getString(R.string.lbl_choose_removefrom_gallery)};
        builder.setItems(animals, (dialog, which) -> {
            switch (which) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    listener.onChooseGalleryRemoveSelected();
                    break;
            }
        });
    ...
    private void cropImage(Uri sourceUri) {
        ...
        // applying UI theme
        options.setToolbarColor(ContextCompat.getColor(this, R.color.prim));
